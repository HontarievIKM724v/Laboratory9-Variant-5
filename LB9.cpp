...
//Створити двовимірний масив, що складається з дійсних чисел.
// Знайти добуток двох максимальних і різницю двох мінімальних елементів двовимірного масиву.
// Створити одновимірний масив, що складається з сум елементів рядків двовимірного масиву.
